...
class TradingObject(models.Model):
    ...
    name = models.CharField(
        max_length=250, verbose_name="Название объекта торговой сети"
    )
    ...
    email = models.EmailField(
        unique=True, verbose_name="Электронная почта объекта торговой сети"
    )
    country = models.CharField(
        max_length=150, verbose_name="Страна объекта торговой сети"
    )
    city = models.CharField(max_length=150, verbose_name="Город объекта торговой сети")
    street = models.CharField(
        max_length=150, verbose_name="Улица объекта торговой сети"
    )
    house_number = models.CharField(
        max_length=20, verbose_name="Номер дома объекта торговой сети"
    )
    ...
    created_at = models.TimeField(
        auto_now_add=True, verbose_name="Время создания объекта торговой сети"
    )
